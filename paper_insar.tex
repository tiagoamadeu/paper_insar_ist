...
\usepackage{enumitem}
\setlist[itemize]{
    left=1em,       % pequeno recuo à esquerda
    labelsep=0.5em, % espaço entre o bullet e o texto
    topsep=0pt,     % remove espaço acima da lista
    partopsep=0pt, 
    parsep=0pt,     % remove espaçamento entre parágrafos dentro da lista
    itemsep=0pt     % remove espaçamento extra entre itens
}
\setlist[enumerate]{
    left=1em,
    labelsep=0.5em,
...
\usepackage{booktabs}      % linhas horizontais bonitas
\usepackage{multirow}      % células múltiplas
\usepackage{ragged2e}      % alinhamento de texto em colunas
...
\titlespacing*{\paragraph}{0pt}{*1}{*0}[\\]  % run-in + quebra de linha
...
% =======================
% Listas com pequeno recuo
% =======================
\usepackage{enumitem}
\setlist[itemize]{
    left=1em,       % pequeno recuo à esquerda
    labelsep=0.5em, % espaço entre o bullet e o texto
    topsep=0pt,     % espaço acima da lista
    partopsep=0pt, 
    parsep=0pt, 
    itemsep=0.5em   % espaço entre itens da lista
}
\setlist[enumerate]{
    left=1em,
    labelsep=0.5em,
...
% =======================
% Comandos adicionais para alinhamento de parágrafos em tabelas
% =======================
