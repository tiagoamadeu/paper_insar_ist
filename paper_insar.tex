...
% ---------------------------------------------------------
% CONTEXTO E IMPORTÂNCIA (Pilar da Segurança)
% ---------------------------------------------------------

\subsection{Context}
Importância das barragens e o caso do Alqueva.
...
% ---------------------------------------------------------
% ESTADO DA ARTE E LIMITAÇÕES (Zotero: Hariri-Ardebili, 2023)
% NOTA: Usar as limitações para justificar o GAP de integração
% ---------------------------------------------------------

\subsection{O Estado da Arte (As tuas tags do Zotero)}
Aqui citas os outros autores. "Estudos recentes mostram que o InSAR funciona [Autor A], mas apresentam limitações em X [Tag: Limitations], pelo que o meu trabalho visa aprimorar essas limitações com [meu método]."

Estudos recentes:
Some authors proposed a framework for monitoring geotechnical structures using InSAR and machine learning \parencite{xie2022, cernuto2026}. \cite{cernuto2026} concluded that "The separate analyses of ascending and descending geometries revealed their complementarity, suggesting that their integration represents a potential advancement toward a more comprehensive characterization of deformation phenomena." and "...the proposed method provides an operational framework for large-scale evaluation of landslide–infrastructure interaction, serving as a valuable preliminary support for risk management and the planning of more detailed investigations."

Limitações:
\parencite{hariri-ardebili2023} "On the other hand, its limitations can be summarized as: (i) relies on satellite availability and suitable imaging conditions, which can be limited in certain regions, (ii) data processing and analysis may require expertise in remote sensing techniques, and (iii) accuracy and resolution of satellite imagery may vary depending on the sensor and orbit."

\parencite{hariri-ardebili2023} "Machine learning models require large amounts of high-quality data to train effectively. However, dam engineering data is often limited, incomplete, and scattered across various sources."

Apesar dos avanços... referir a contribuição do meu trabalho:



\subsection{A Oportunidade}
"O surgimento do EGMS em 2022 abre uma oportunidade [Tag: Opportunity] técnica que antes não existia." Começas com a importância do Alqueva e da segurança. Dizes que os métodos in-situ são o "padrão de ouro" (importante para não ofender os engenheiros tradicionais!), mas apontas logo a limitação: são pontuais e caros. Narrativa: Introduzes o InSAR e o EGMS. Explicas que o EGMS resolveu a "complexidade e o custo" (citas o autor de 2018 aqui). O Gap: Referes que, embora os dados existam (Big Data), a sua validação em infraestruturas críticas como o Alqueva ainda é rara.
...
\subsection{A Solução (O teu contributo)}
...
\subsection{Fundamentals of InSAR and Earth Observation}
...
\subsection{Interferometric techniques and time-series approaches}
...
Within the InSAR family, several specialized techniques have been developed to enhance temporal and spatial precision. Differential InSAR (DInSAR) provides highly accurate surface deformation measurements over time, making it suitable for monitoring slow-moving geotechnical phenomena \parencite{derauwOngoingAutomatedGround2020a}. The Persistent Scatterer InSAR (PSInSAR) technique is particularly effective for detecting subtle and long-term ground movements by analysing stable reflectors that maintain coherence over time \parencite{hariri-ardebiliAdvancesDamEngineering2020}. Meanwhile, the Small Baseline Subset (SBAS) approach minimizes spatial and temporal baselines between image pairs, improving temporal coherence and reducing decorrelation, making it especially suitable for localized deformation studies \parencite{parkNonlinearModelingSubsidence2021a}.

More recently, these methods have been extended to advanced displacement modelling and calibration workflows \parencite{schlogl2021,tu2023}, allowing for a more robust estimation of three-dimensional ground motion and improved interpretation of geotechnical processes.

\subsection{Clustering and data mining in InSAR}
\begin{itemize}
...
\subsection{Applications in geotechnical monitoring}
